...
- [ ] 해당 품목 상품들의 재고상황에 따른 구매 응답을 반환하는 기능
    - [x] 해당 상품의 재고가 부족할 경우, 재고 부족 응답을 반환합니다.
    - [ ] 해당 품목에 프로모션 상품이 있는 경우, 프로모션 상품 재고를 먼저 검사합니다.
        - [ ] 해당 품목의 프로모션 정보에 따라 요청 수량에 따른 구매 응답을 반환합니다.
    - [ ] 구매 가능할 경우, 정상 구매 응답을 반환합니다.

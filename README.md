...
- ~~요청 수량에 대해 정상 결제 안내~~ 안내하지 않고 정상 결제 진행

> ~~프로모션 기간에 대한 메세지를 추가하지 않고 기존의 정상 결제 안내 메세지로 통일한다.~~
> <br> 주어진 테스트 케이스에 맞춰 별도의 메세지 없이 해당 수량 만큼 정상 결제를 진행하는 것으로 한다.
...
- [x] 편의점 시스템을 동작합니다.
    - [x] 사용자의 각 입력이 올바르게 들어올 때까지 입력을 다시 받습니다.
    - [x] 사용자의 입력을 관리자에게 전달하고 관리자로부터 나온 결과물을 사용자에게 전달합니다.
